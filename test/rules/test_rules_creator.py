...
def test_callback_gets_called(assertions):
    c = RuleCreator(
...
def test_callback_throws_without_type(assertions):
...
def test_defaults_to_zero_priority(assertions):
