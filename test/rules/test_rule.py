...
def test_ordering_with_changes():
    r0 = Rule(dummy, priority=0)
    r1 = Rule(dummy, priority=1)
...
def test_f_none_subclass_without_call_raises():
    class B(Rule):
        pass
...
def test_call_recursion_prevention():
...
def test_hash_equals_name_hash():
    r1 = Rule(dummy, name='test')
